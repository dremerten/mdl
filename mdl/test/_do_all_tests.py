#!/usr/bin/env python3
"""Script to test all the mdl unittests.

1)  This script runs each unittest script in mdl's
    mdl.test module.
...
def run_script(cli_string):
    ...
    slurpy_returncode = ('----- mdl Return Code '
                         '----------------------------------------')
    slurpy_stdoutdata = ('----- mdl Test Output '
                         '----------------------------------------')
    slurpy_stderrdata = ('----- mdl Test Error '
                         '-----------------------------------------')
